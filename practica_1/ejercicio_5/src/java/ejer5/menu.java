...
public class menu extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<td>");
            out.println("<br>");
            out.println("<h1 align='center'>Operaciones</h1>");
            out.println("<form action='salir' method='post'>");
            out.println("<label>Ingrese numero</label>");
            out.println("<input type='text' name='nu'>");
            out.println("<br><br>");
            out.println("<label>Ingrese numero</label>");
            out.println("<input type='text' name='num'>");
            out.println("<br><br>");
            out.println("<label name='op'>Elija una operacion</lavel>");
            out.println("<select name='opc' id='op'>");
